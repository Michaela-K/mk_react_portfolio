      ...
      <div className="about__section__content__box">
        <div className="about__section__content">
          ...
          <p className="about__section-description">
            ...
            challenge of it and the pore raising satisfaction when I was able to
            fix bugs in the code.
          </p>
          <p className="about__section-description">
            After that, I immediately dove right back in, teaching myself HTML,
            CSS and JavaScript, by taking part in the #100daysofcodechallenge on
            Twitter, before joining and successfully completing LightHouse Labs'
